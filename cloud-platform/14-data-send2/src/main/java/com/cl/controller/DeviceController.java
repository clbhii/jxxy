...
public class DeviceController {
    ...
    @RequestMapping("/listDeviceField")
    @ResponseBody
    public Result<List<DeviceFieldDO>> listDeviceField(Long devId) {
        List<DeviceFieldDO> deviceFieldDOS = deviceService.selectByDevId(devId);
        return new ResultSupport<List<DeviceFieldDO>>(true, deviceFieldDOS);
    }
