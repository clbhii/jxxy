			...
			$.post("../user/logout",
				...
				function(data,status){
					if (data != null && data.success) {
						$.messager.alert("提示", "退出成功", "info");
						window.location = "../mvc/login";
					} else {
...
<body class="easyui-layout">
	...
	%>
		<div data-options="region:'north',border:false" style="height:60px;background:#B3DFDA;padding:10px">
			...
			<div style="float:right;width:10%;font-size: 250%"><%=name%>
				<a href="javascript:void(0)"  onclick="logout()" style="width:90px">退出</a>
			</div>
